...
class EventHPCreatureCreature(EventHPCreature):
    def __init__(self, id, gamemaster, old_hp: int, new_hp: int, effect_card_owner: Player, effect_card: CardCreature, target_card_owner: Player, target_card: CardCreature):
