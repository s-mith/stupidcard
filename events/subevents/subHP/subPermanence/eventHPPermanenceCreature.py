...
class EventHPPermanenceCreature(EventHPPermanence):
    def __init__(self, id, gamemaster, old_hp: int, new_hp: int, effect_permanence_owner: Player, effect_permanence: Permanence, target_card_owner: Player, target_card: CardCreature):
